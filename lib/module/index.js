...
const LINKING_ERROR = `The package 'react-native-pax-poslink' doesn't seem to be linked. Make sure: \n\n` + Platform.select({
...
export function makePayment(amount) {
  let _tip = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "0";
